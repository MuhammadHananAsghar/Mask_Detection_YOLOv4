...
# --> Extracting 10% of paths to save into test.txt file -->
...
for current_dir, dirs, files in os.walk('.'):
    ...
    for f in files:
        # Checking if filename ends with '.jpeg, .jpg, .png'
...
# Slicing first 10% of elements from the list
...
with open('/home/zerosec/Downloads/Model_Files/yolov3/train.txt', 'w') as train_txt:
...
with open('/home/zerosec/Downloads/Model_Files/yolov3/test.txt', 'w') as test_txt:
    # Going through all elements of the list
    for e in p_test:
        # Writing current path at the end of the file
        test_txt.write(e)
